...
error_reporting(E_ALL);
  ...
  <div class="container">
    ...
    <form method="POST" autocomplete="off">
      ...
      <!--Phone No.-->
      <div class="form-floating mb-3">
        <input class="form-control" type="tel" name="phone" id="phone" value="<?php echo $phone; ?>" maxlength="10" pattern="[1-9]{1}[0-9]{9}" placeholder="Enter your Phone no.">
      ...
      <select id="city" name="city">
        ...
        <option>Vallabh Vidhyanagar</option>
        <option>Other</option>
      </select>
      </div>
